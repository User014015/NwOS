 ...
 * ============================================================
 *
 * NWO bytecode is generated by compiler/codegen.c.
 *
 ...
 *      NwOS
 *
 * This VM is intentionally small and 32-bit friendly.
 */
...
typedef struct
{
    ...
    {
        /*
         * Keep integer arithmetic 32-bit.
         */
        int integer;

        /*
         * Kept for future float support.
         */
        double floating;
...
/*
 * Read a length-prefixed string from bytecode.
 *
 * The returned pointer points directly into the .nwo code
 * buffer. The string is NOT necessarily NUL terminated.
 */
    ...
    VmValue* b)
{
     ...
     * String comparison.
     *
     * Since a VM string currently points directly into the
     * NWO code image, we cannot know its length from VmValue.
     * Therefore strings are not compared here yet.
     *
     * This will be fixed when the VM gets a real string object.
     */
    if (a->type == VM_STRING ||
        b->type == VM_STRING)
    {
    ...
    VmValue* value)
{
    ...
    switch (value->type)
    {
        ...
        case VM_FLOAT:
            /*
             * Minimal temporary float handling.
             *
             * Full float formatting is intentionally
             * postponed until the VM gets proper float
             * runtime support.
             */
            print_int(
    ...
    while (vm.running)
    {
        ...
        switch (opcode)
        {
            ...
            case OP_PUSH_FLOAT:
            {
                ...
                /*
                 * Copy raw IEEE-754 bits into double.
                 *
                 * No floating-point calculation is performed
                 * here.
                 */
                {
                    unsigned char* dst =
            ...
            case OP_LOAD:
            {
                ...
                /*
                 * Uninitialized int defaults to 0.
                 */
            ...
            case OP_STORE:
            {
                 ...
                 *     string(name)
                 *
                 * therefore value is already on stack.
                 */
                if (!vm_pop(
                        &vm,
                        &value))
            ...
            case OP_TIME:
                ...
                /*
                 * codegen currently emits OP_TIME without
                 * an argument.
                 *
                 * Leave it as a placeholder until codegen
                 * encodes milliseconds.
                 */
                break;
            ...
            case OP_CALL:
            {
                ...
                /*
                 * Function CALL is not implemented in this
                 * first runtime revision.
                 *
                 * Consume the name so the bytecode reader
                 * remains synchronized before returning the
                 * runtime error.
                 */
                if (!vm_read_u32(
                        &vm,
            ...
            case OP_FUNC_END:
                ...
                /*
                 * Reaching end of main() without explicit
                 * return is a successful exit.
                 */
                vm.running = 0;
                vm.result = 0;
